...
from vits_extend.train_content_aug import train
...
if __name__ == '__main__':
    ...
    assert hp.data.hop_length == 320 or hp.data.hop_length == 256, \
        'hp.data.hop_length must be equal to 320(256), got %d' % hp.data.hop_length
